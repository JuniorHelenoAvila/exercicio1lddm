                ...
                child: Column(
                  children: <Widget>[
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          setState(() {
                            ...
                            totalPessoa =
                                (totalConta + totalGorjeta) / quantPessoas;
                          });
                        },
                      ),
                    ),
                    ...
                    Column(children: <Widget>[
                      ...
                      Slider(
                          value: porcentagemGarcom.toDouble(),
                          onChanged: (value) {
                            setState(() {
                              porcentagemGarcom = value.toInt();
                              totalGorjeta =
                                  (porcentagemGarcom / 100) * totalConta;
                              totalPessoa =
                                  (totalConta + totalGorjeta) / quantPessoas;
                            });
                          },
...
class _screenTwoState extends State<screenTwo> {
  int quantBebintes = 1;
  double totalBebida = 0.0; // valor das bebidas a ser subtraido da conta total
  double totalBase =
      0.0; // valor pra quem n bebeu e valor a ser acrescido pra quem bebeu
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: RaisedButton(
                        onPressed: () {
                          setState(() {
                            totalBase = (totalConta - totalBebida) /
                                quantPessoas; // calculo preco base
                            contaBebinte = totalBase +
                                (totalBebida /
                                    quantBebintes); // valor pra quem bebeu (preco base + divisao da bebida)
                          });
                        },
                        child: Text("CALCULAR",
                            style:
